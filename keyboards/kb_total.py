...
client = InlineKeyboardButton(text='Клиент', callback_data='client')
admin = InlineKeyboardButton(text='Эксперт', callback_data='admin')
kb_role = InlineKeyboardMarkup(inline_keyboard=[[client, admin]])
...
telegram: InlineKeyboardButton = InlineKeyboardButton(text='Написать в ТГ ->', url='https://t.me/f_o_x_y_s')
